				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						...
						<li>
							...
							<li class="active">Group Subject Table</li>
						</ul><!-- /.breadcrumb -->
												...
												<div class="row">
													<div class="col-xs-12 col-sm-7">
														<div class="form-group">
															...
															<div>
																<select class="chosen-select form-control" name="day" data-placeholder="Choose a day...">
													...
													<label for="form-field-username">Subject ID</label>
														...
														<div>
															<select name="sub_id" class="chosen-select form-control" id="sub_id" data-placeholder="sub_id" value="" />
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<div class="table-header">
											Results for "Group Subject Table"
										</div>
															...
															<!-- <div class="hidden-md hidden-lg">
																<div class="inline pos-rel">
																	...
																	<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																		...
																		<li>
																			<a href="#modal-form" class="tooltip-success" data-rel="tooltip" title="Edit">
																				<span class="green">
											...
											<div class="modal-content">
												...
												<div class="modal-body">
													<form>
														...
														<label for="form-field-username">Teacher ID</label>
															<div>
																<input type="text" name="teacher_id" class="chosen-select form-control" id="teacher_id" placeholder="TAEXXX" value="" />
															</div>
														...
														<label for="form-field-username">Subject ID</label>
															...
															<div>
																<input type="text" name="sub_id" class="chosen-select form-control" id="sub_id" placeholder="sub_id" value="" />
															</div>
								...
								<div id="delete" class="modal" tabindex="-1">
									<div class="modal-dialog">
										<div class="modal-content">
											<div class="modal-header">
												<button type="button" class="close" data-dismiss="modal">&times;</button>
												<h4 class="blue bigger">Do you want to delete ?</h4>
											</div>
											...
											<div class="modal-body" >
												<div class="row">
													<div class="col-xs-12 col-sm-7">
														...
														<input type="submit" value = "{{$timetable -> id}}" class="btn btn-sm btn-danger btn-primary">
													</div>
												</div>
											</div>
...
<![endif]-->
		...
		<script type="text/javascript">
			...
			$('#modal-form').on('change', function(e){
        console.log(e);
        var teacher = 'sa';
				//document.write(teacher);
        $.get('/json-sub_id?teacher=' + teacher,function(data) {
          console.log(data);
          //$('#sub_id').empty();
          //$('#sub_id').append('<option value="0" disable="true" selected="true">=== Select Regencies ===</option>');

          document.write('k');
          // $.each(data, function(index, regenciesObj){
          //   $('#sub_id').append('<option value="'+ regenciesObj.id +'">'+ regenciesObj.name +'</option>');
          // })
        });
      });
