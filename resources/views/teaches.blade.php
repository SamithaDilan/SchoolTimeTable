				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						...
						<li>
							...
							<li class="active">Teaches Table</li>
						</ul><!-- /.breadcrumb -->
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form method = "post" action = "{{route('saveTeaches')}}">
								{{csrf_field()}}
								@if ($errors->any())
												...
												<div class="row">
													<div class="col-xs-12 col-sm-7">
														...
														<div class="form-group">
															...
															<select class="form-control" name="teacher_id" id="teacher_id" data-parsley-required="true">
														...
														<div class="form-group">
															...
															<select class="form-control" name="sub_id" id="sub_id" data-parsley-required="true">
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<tr>
														<td class="center">
															<label class="pos-rel">
																<input type="checkbox" class="ace" name = "{{$teach -> id}}" />
																<span class="lbl"></span>
															</label>
														</td>
														...
														<td align = 'center'>
															<div class="hidden-sm hidden-xs action-buttons">
																 ...
																 <a role="button"  data-toggle="modal" data-target="#modal_update" data-id="{{$teach -> id}}" data-teacher_id="{{$teach -> teacher_id}}"  data-sub_id="{{$teach -> sub_id}}" ><i class="ace-icon fa fa-pencil bigger-130"></i></a>
																
																 <a class = "red" role="button"  data-toggle="modal" data-target="#delete" data-id="{{$teach -> id}}"><i class="ace-icon fa fa-trash-o bigger-120 "></i></i></a>
								...
								<form method = "post" action = "{{route('updateTeaches')}}">
								...
								<form method = "post" action = "{{route('destroyTeaches')}}" >
									{{csrf_field()}}
									{{ method_field('POST') }}
									<div class = "center" >
										<div class = "container" >
...
<![endif]-->
		...
		<script type="text/javascript">
			jQuery(function($) {
				...
				$('#modal_update-form').on('show.bs.modal', function (event) {
				...
				$('#modal_update').on('show.bs.modal', function(e) {
							...
							var sub_id = $(e.relatedTarget).data('sub_id');
							var id = $(e.relatedTarget).data('id');

							//populate the textbox
							$(e.currentTarget).find('input[name="teacher_id"]').val(teacher_id);
							$(e.currentTarget).find('input[name="sub_id"]').val(sub_id);
