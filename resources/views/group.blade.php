				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						...
						<li>
							...
							<li class="active">Group Table</li>
						</ul><!-- /.breadcrumb -->
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form method = "post" action = "{{route('saveGroup')}}">
								{{csrf_field()}}
								@if ($errors->any())
												...
												<div class="row">
													<div class="col-xs-12 col-sm-7">
														...
														<div class="form-group">
															...
															<div>
																<input type="text" name="group" class="chosen-select form-control" id="group" placeholder="Type group code" value="" />
															</div>
														</div>
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<tr>
														<td class="center">
															<label class="pos-rel">
																<input type="checkbox" class="ace" name = "{{$group -> id}}" />
																<span class="lbl"></span>
															</label>
														</td>
														<td>{{$group -> id}}</td>
														...
														<td align = 'center'>
															<div class="hidden-sm hidden-xs action-buttons">
																 ...
																 <a role="button"  data-toggle="modal" data-target="#modal_update" data-id="{{$group -> id}}" data-group="{{$group -> group}}"  ><i class="ace-icon fa fa-pencil bigger-130"></i></a>
																
																 <a class = "red" role="button"  data-toggle="modal" data-target="#delete" data-id="{{$group -> id}}"><i class="ace-icon fa fa-trash-o bigger-120 "></i></i></a>
									...
									<div class="modal fade" id="modal_update" tabindex="-1" role="dialog" aria-labelledby="modelUpdate" aria-hidden="true">
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<div class="modal-body">
													<form>
														<label for="form-field-username">Group</label>
															
														<input type="text" name="group" class="chosen-select form-control" id="group" placeholder="group" value="" />
								...
								<form method = "post" action = "{{route('destroyGroup')}}" >
									{{csrf_field()}}
									{{ method_field('POST') }}
									<div class = "center" >
										<div class = "container" >
