				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						...
						<li>
							...
							<li class="active">Period Table</li>
						</ul><!-- /.breadcrumb -->
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form method = "post" action = "{{route('savePeriod')}}">
								{{csrf_field()}}
								@if ($errors->any())
											...
											<div class="modal-body">
												<div class="row">
													<div class="col-xs-12 col-sm-7">
														...
														<div class="form-group">
															<label for="form-field-username">Period</label>

															<div>
																<input type="text" name="period" class="chosen-select form-control" id="Grade_code" placeholder="Type period code" value="" />
															</div>
														</div>
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<tr>
														<td class="center">
															<label class="pos-rel">
																<input type="checkbox" class="ace" name = "{{$period -> id}}" />
																<span class="lbl"></span>
															</label>
														</td>
														...
														<td align = 'center'>
															<div class="hidden-sm hidden-xs action-buttons">
																 ...
																 <a role="button"  data-toggle="modal" data-target="#modal_update" data-id="{{$period -> id}}" data-period="{{$period -> period}}"  ><i class="ace-icon fa fa-pencil bigger-130"></i></a>
																
																 <a class = "red" role="button"  data-toggle="modal" data-target="#delete" data-id="{{$period -> id}}"><i class="ace-icon fa fa-trash-o bigger-120 "></i></i></a>
								...
								<form method = "post" action = "{{route('updatePeriod')}}">
											...
											<div class="modal-content">
												...
												<div class="modal-body">
													<form>
														...
														<input type="text" name="period" class="chosen-select form-control" id="period" placeholder="period" value="" />
								...
								<form method = "post" action = "{{route('destroyPeriod')}}" >
									{{csrf_field()}}
									{{ method_field('POST') }}
									<div class = "center" >
										<div class = "container" >
