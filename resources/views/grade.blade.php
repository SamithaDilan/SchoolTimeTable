					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
												...
												<div class="row">
													<div class="col-xs-12 col-sm-7">
														...
														<div class="form-group">
															<label for="form-field-username">Grade</label>

															<div>
																<input type="text" name="Grade_code" class="chosen-select form-control" id="Grade_code" placeholder="Type grade code" value="" />
															</div>
														</div>
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<tr>
														<td class="center">
															<label class="pos-rel">
																<input type="checkbox" class="ace" name = "{{$grade -> id}}" />
																<span class="lbl"></span>
															</label>
														</td>
														...
														<td align = 'center'>
															<div class="hidden-sm hidden-xs action-buttons">
																 ...
																 <a role="button"  data-toggle="modal" data-target="#modal_update" data-id="{{$grade -> id}}" data-grade="{{$grade -> Grade_code}}" ><i class="ace-icon fa fa-pencil bigger-130"></i></a>
																
																 <a class = "red" role="button"  data-toggle="modal" data-target="#delete" data-id="{{$grade -> id}}"><i class="ace-icon fa fa-trash-o bigger-120 "></i></i></a>
								...
								@endif
									<div class="modal fade" id="modal_update" tabindex="-1" role="dialog" aria-labelledby="modelUpdate" aria-hidden="true">
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												<div class="modal-header">
													<h5 class="modal-title" id="modelUpdate">Edit Grade</h5>
												...
												<div class="modal-body">
													...
													<label for="form-field-username">Grade</label>
															<input type="text" name="grade_id" class="chosen-select form-control" id="grade_id" placeholder="grade_id" value="" />
								...
								<form method = "post" action = "{{route('destroyGrade')}}" >
									{{csrf_field()}}
									{{ method_field('POST') }}
									<div class = "center" >
										<div class = "container" >
...
<![endif]-->
		...
		<script type="text/javascript">
			...
			// 	var Grade_code = button.data('Grade_code') // Extract info from data-* attributes
			...
			$('#modal_update').on('show.bs.modal', function(e) {
					...
					var grades = $(e.relatedTarget).data('grade');
					var id = $(e.relatedTarget).data('id');

					//populate the textbox
					$(e.currentTarget).find('input[name="grade_id"]').val(grades);
