																		...
																		<tr>
																			...
																			<td>
																				@foreach($timetables as $timetable)
																					@if ($timetable -> day == 'MON' and $timetable -> period == $i) 
																						{{$timetable ->sub_id}}
																					@endif
																				@endforeach
																			</td>
																			<td>
																				@foreach($timetables as $timetable)
																					@if ($timetable -> day == 'TUE' and $timetable -> period == $i) 
																						{{$timetable -> sub_id}}
																						@endif
																				@endforeach
																			</td>
																			<td>
																				@foreach($timetables as $timetable)
																					@if ( $timetable -> day == 'WED' and $timetable -> period == $i) 
																						{{$timetable -> sub_id}}
																					@endif
																				@endforeach
																			</td>
																			<td>
																				@foreach($timetables as $timetable)
																					@if ($timetable -> day == 'THU' and $timetable -> period == $i) 
																						{{$timetable -> sub_id}}
																					@endif
																				@endforeach
																			</td>
																			<td>
																				@foreach($timetables as $timetable)
																					@if ( $timetable -> day == 'FRI' and $timetable -> period == $i) 
																						{{$timetable -> sub_id}}
																					@endif
																				@endforeach
																			</td>																																					
